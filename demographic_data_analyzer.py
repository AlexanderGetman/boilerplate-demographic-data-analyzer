...
def calculate_demographic_data(print_data=True):
    ...
    percentage_bachelors = (df['education'].value_counts() / df['education'].count() * 100)['Bachelors'].round(1)
    ...
    rich_percentage = df[(num_min_workers) & (df['salary'] == '>50K')].shape[0] / df[num_min_workers].shape[0] * 100
